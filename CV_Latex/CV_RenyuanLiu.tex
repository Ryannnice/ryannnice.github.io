...
\begin{itemize}[left = -0.22in]
	...
	\vspace{-0.5em}
	\item \textbf{Large model algorithms:} Evaluated DeepSeek V4 Flash and Pro models by \textbf{vLLM} framework on 16 and 32 \textbf{Ascend 910B} NPUs, separately; developed an LLM routing system whose semantic-based algorithm reduced cost by \textbf{62\%} while controlling the accuracy loss within \textbf{10\%}; currently continuing work on large-model deployment and optimization, especially on Ascend chips.
\end{itemize}
